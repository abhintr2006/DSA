  ...
  <diagram id="stack-design" name="Full Stack Architecture">
    <mxGraphModel dx="1400" dy="1200" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1169" pageHeight="827" math="0" shadow="0">
      <root>
        ...
        <!-- User Actor -->
        <mxCell id="user" value="Client&lt;br&gt;(Browser/App)" style="shape=umlActor;verticalLabelPosition=bottom;verticalAlign=top;html=1;outlineConnect=0;fillColor=#e3f2fd;strokeColor=#1e88e5;strokeWidth=2;fontFamily=Inter, Helvetica, sans-serif;fontSize=16;fontStyle=1;fontColor=#1565c0;" vertex="1" parent="1">
        ...
        <!-- Edges -->
        <mxCell id="edge1" value="HTTPS / UI Interaction" style="edgeStyle=orthogonalEdgeStyle;curved=1;rounded=1;strokeColor=#495057;strokeWidth=2;html=1;fontFamily=Inter, Helvetica, sans-serif;fontSize=14;fontColor=#000000;fontStyle=1;labelBackgroundColor=#ffffff;labelBorderColor=#ced4da;" edge="1" parent="1" source="user" target="frontend">
          <mxGeometry width="50" height="50" relative="1" as="geometry" />
        </mxCell>
        
        <mxCell id="edge2" value="REST / GraphQL API" style="edgeStyle=orthogonalEdgeStyle;curved=1;rounded=1;strokeColor=#495057;strokeWidth=2;html=1;fontFamily=Inter, Helvetica, sans-serif;fontSize=14;fontColor=#000000;fontStyle=1;labelBackgroundColor=#ffffff;labelBorderColor=#ced4da;" edge="1" parent="1" source="frontend" target="backend">
          <mxGeometry width="50" height="50" relative="1" as="geometry" />
        </mxCell>

        <mxCell id="edge3" value="SQL / ORM Queries" style="edgeStyle=orthogonalEdgeStyle;curved=1;rounded=1;strokeColor=#495057;strokeWidth=2;html=1;fontFamily=Inter, Helvetica, sans-serif;fontSize=14;fontColor=#000000;fontStyle=1;labelBackgroundColor=#ffffff;labelBorderColor=#ced4da;" edge="1" parent="1" source="backend" target="database">
          <mxGeometry width="50" height="50" relative="1" as="geometry" />
        </mxCell>
...
console.log("Created frontend-backend-db.drawio.svg");
